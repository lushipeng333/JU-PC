  ...
  <div class="mes_project">
    ...
    <div class="mes_project_conter">
      <!-- 添加或修改参数配置对话框 -->
        ...
        <el-form ref="form" :model="form" :rules="rules" label-width="100px" v-show="addupdate">
          <el-row>
            <el-col>
  ...
  export default {
    ...
    methods: {
      ...
      handleDelete() {
        ...
        if(this.as.indexOf("2") == -1 || this.as.indexOf("3") == -1 || this.as.indexOf("5") == -1){
          this.statusjudge == true
        }else{
      ...
      handleImport() {
        ...
        this.upload.data.projectId = this.ids[0]
      },
      /** 下载模板操作 */
      importTemplate() {
      ...
      handleFileSuccess(response, file, fileList) {
        ...
        this.getList();
        listMes_project_detail(this.upload.data.projectId).then(res => {
          this.projectListDetail = res.rows
        })
      },
      // 提交上传文件
